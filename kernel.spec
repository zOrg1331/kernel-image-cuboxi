...
%define rhel 1
%if %{rhel}
%define rhel_build 71.7.1
%define distro_build 042test007
%define buildid .1
...
# scripts use them.
#
%define kernel_prereq  fileutils, module-init-tools, initscripts >= 8.11.1-1, kernel-firmware >= %{rpmversion}-%{rhel_release}, grubby >= 7.0.4-1
%if %{with_dracut}
