...
%changelog
* Wed Jul 04 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.139-alt0.M70C.1
- v4.4.139

* Tue Jun 19 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.138-alt0.M70C.1
- v4.4.138  (Fixes: CVE-2018-10853)

* Fri Jun 08 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.136-alt0.M70C.1
- v4.4.136

* Thu May 31 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.135-alt0.M70C.1
- v4.4.135

* Wed May 30 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.134-alt0.M70C.1
- v4.4.134  (Fixes: CVE-2018-6412)

* Mon May 28 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.133-alt0.M70C.1
- v4.4.133

* Wed May 16 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.132-alt0.M70C.1
- v4.4.132

* Sun May 06 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.131-alt0.M70C.1
- v4.4.131  (Fixes: CVE-2018-1093)

* Tue Apr 24 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.129-alt0.M70C.1
- v4.4.129  (Fixes: CVE-2018-1092)

* Mon Apr 16 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.128-alt0.M70C.1
- v4.4.128

* Mon Apr 09 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.127-alt0.M70C.1
- v4.4.127

* Sun Apr 01 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.126-alt0.M70C.1
- v4.4.126  (Fixes: CVE-2017-8824)

* Thu Mar 29 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.125-alt0.M70C.1
- v4.4.125

* Sun Mar 25 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.124-alt0.M70C.1
- v4.4.124

* Thu Mar 22 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.123-alt0.M70C.1
- v4.4.123

* Mon Mar 19 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.122-alt0.M70C.1
- v4.4.122  (Fixes: CVE-2018-1000004)

* Mon Mar 12 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.121-alt0.M70C.1
- v4.4.121

* Tue Mar 06 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.120-alt0.M70C.1
- v4.4.120

* Wed Feb 28 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.119-alt0.M70C.1
- v4.4.119

* Tue Feb 27 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.118-alt0.M70C.1
- v4.4.118

* Fri Feb 23 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.117-alt0.M70C.1
- v4.4.117

* Mon Feb 19 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.116-alt0.M70C.1
- v4.4.116  (Fixes: CVE-2017-8824)

* Mon Feb 05 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.115-alt0.M70C.1
- v4.4.115  (Fixes: CVE-2017-5715)

* Wed Jan 31 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.114-alt0.M70C.1
- v4.4.114

* Thu Jan 25 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.113-alt0.M70C.1
- v4.4.113

* Wed Jan 17 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.112-alt0.M70C.1
- v4.4.112  (Fixes: CVE-2017-1000410, CVE-2017-17741, CVE-2017-5753)

* Wed Jan 10 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.111-alt0.M70C.1
- v4.4.111

* Tue Jan 09 2018 Kernel Bot <kernelbot@altlinux.org> 1:4.4.110-alt0.M70C.1
- v4.4.110

* Mon Dec 25 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.108-alt0.M70C.1
- v4.4.108

* Mon Dec 25 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.107-alt0.M70C.1.1
- SMACK enabled
- kernel.unprivileged_bpf_disabled set by default

* Wed Dec 20 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.107-alt0.M70C.1
- v4.4.107

* Sun Dec 17 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.106-alt0.M70C.1
- v4.4.106   (Fixes: CVE-2017-0861, CVE-2017-1000407)

* Mon Dec 11 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.105-alt0.M70C.1
- v4.4.105

* Wed Dec 06 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.104-alt0.M70C.1
- v4.4.104   (Fixes: CVE-2017-8824)

* Tue Dec 05 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.103-alt0.M70C.1.1.1
- separate drm modules for old cards into subpackage
- package modules_dir/kernel/drivers/staging/media

* Tue Dec 05 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.103-alt0.M70C.1.1
- temporary fix for HugeDirtyCowPOC (fixes CVE-2017-1000405)

* Tue Dec 05 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.103-alt0.M70C.1
- v4.4.103

* Fri Nov 24 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.102-alt0.M70C.1
- v4.4.102

* Wed Nov 22 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.100-alt0.M70C.1
- v4.4.100   (Fixes: CVE-2017-7518)

* Sat Nov 18 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.99-alt0.M70C.1
- v4.4.99   (Fixes: CVE-2017-13080)

* Wed Nov 15 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.98-alt0.M70C.1
- v4.4.98

* Wed Nov 08 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.97-alt0.M70C.1
- v4.4.97

* Thu Nov 02 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.96-alt0.M70C.1
- v4.4.96   (Fixes: CVE-2017-12193)

* Fri Oct 27 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.95-alt0.M70C.1
- v4.4.95

* Thu Oct 19 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.93-alt0.M70C.1
- kernel version up in c7

* Wed Oct 18 2017 Kernel Bot <kernelbot@altlinux.org> 1:4.4.93-alt0.M80C.1.1
- v4.4.93   (Fixes: CVE-2017-0786, CVE-2017-15265)

* Tue Oct 17 2017 Kernel Bot <kernelbot@altlinux.org> 1:3.14.59-alt1.M70C.10
