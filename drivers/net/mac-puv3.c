...
static int umal_mii_reset(struct mii_bus *bus)
{
	writel(UMAL_MIICFG_RESET, UMAL_MIICFG); /* reset the MII management */
	writel(0, UMAL_MIICFG);		/* enable the MII management */
...
static int umal_open(struct net_device *dev)
{
	...
	writel(0x0fff0fff, UMAL_FIFOCFG1);	/* request enable modules in fifo */
	writel(0x0aaa0555, UMAL_FIFOCFG2);	/* request enable modules in fifo */
	writel(0x02800fff, UMAL_FIFOCFG3);	/* set water mark register */
	writel(0x00000070, UMAL_FIFOCFG4);
	writel(0x0007ff8f, UMAL_FIFOCFG5);
	writel(0x0000ff00, UMAL_FIFOCFG0);	/* request enable modules in fifo */
