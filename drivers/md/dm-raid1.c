...
static void do_failures(struct mirror_set *ms, struct bio_list *failures)
{
	 ...
	 * If we have been told to handle errors, hold the bio and wait for
	 * userspace to deal with the problem.
	 * Otherwise pretend that the I/O succeeded. (This would be wrong if
	 * the failed leg returned after reboot and got replicated back to the
	 * good legs.)
	 */
