...
extern void _nfs4_label_free_cap(const struct nfs_server *server, struct nfs4_label *label);
extern void nfs4_label_free_cap(struct inode *dir, struct nfs4_label *label);
#else
static inline void _nfs4_label_free_cap(const struct nfs_server *server, struct nfs4_label *label) {}
