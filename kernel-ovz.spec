...
%define release 128.1.1%{?dist}%{?buildid}
...
# DRBD
Patch90000: patch-linux-2.6.18-rhel5-drbd-8.3.0
...
# Hotfixes, that will be moved to list
Patch120000: diff-ve-fix-walk-tasks-in-audit-tty
