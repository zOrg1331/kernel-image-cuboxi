...
%ifarch %{all_x86}
%define all_arch_configs kernel-%{rpmversion}-i?86*.config.ovz
...
%ifarch x86_64
%define all_arch_configs kernel-%{rpmversion}-x86_64*.config.ovz
%define image_install_path boot
%define signmodules 0
...
%define all_arch_configs kernel-%{rpmversion}-ppc64*.config.ovz
%define image_install_path boot
%define signmodules 0
...
%ifarch s390
%define all_arch_configs kernel-%{rpmversion}-s390*.config.ovz
%define image_install_path boot
...
%ifarch s390x
%define all_arch_configs kernel-%{rpmversion}-s390x*.config.ovz
%define image_install_path boot
%define make_target image
%define kernel_image arch/s390/boot/image
%define hdrarch s390
...
%ifarch sparc
%define all_arch_configs kernel-%{rpmversion}-sparc.config.ovz
%define make_target image
%define kernel_image image
%endif

%ifarch sparc64
%define all_arch_configs kernel-%{rpmversion}-sparc64*.config.ovz
%define make_target image
%define kernel_image image
%endif

%ifarch ppc
%define all_arch_configs kernel-%{rpmversion}-ppc{-,.}*config.ovz
%define image_install_path boot
%define make_target vmlinux
%define kernel_image vmlinux
%define kernel_image_elf 1
...
%ifarch ia64
%define all_arch_configs kernel-%{rpmversion}-ia64*.config.ovz
...
Source200: kernel-%{version}-i686.config.ovz
Source201: kernel-%{version}-i686-PAE.config.ovz
Source202: kernel-%{version}-i686-ent.config.ovz
Source203: kernel-%{version}-x86_64.config.ovz
Source204: kernel-%{version}-ia64.config.ovz
Source205: kernel-%{version}-ppc64.config.ovz
Source206: kernel-%{version}-i686-xen.config.ovz
Source207: kernel-%{version}-x86_64-xen.config.ovz
...
%if %{with_openafs}
    ...
    KernelSrcDir=%{_builddir}/%{name}-%{version}/linux-%{KVERREL}.%{_target_cpu}
    cd $OpenAfsDir
